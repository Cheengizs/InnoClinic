...
public class GetOfficeByIdCommandHandler : IRequestHandler<GetOfficeByIdCommand, Result<OfficeGet>>
{
    private readonly IOfficeRepository _officeRepository;
    private readonly IMapper _mapper;
    
    public GetOfficeByIdCommandHandler(IOfficeRepository officeRepository, IMapper mapper)
    {
        _officeRepository = officeRepository;
        _mapper = mapper;
    }

    public async Task<Result<OfficeGet>> Handle(GetOfficeByIdCommand request, CancellationToken ct)
    {
